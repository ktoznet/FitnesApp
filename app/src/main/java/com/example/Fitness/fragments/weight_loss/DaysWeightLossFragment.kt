package com.example.Fitness.fragments.weight_loss
...
class DaysWeightLossFragment : Fragment(), DaysAdapter.Listener {
    ...
    private fun initRcView() = with(binding) {
         adapter = DaysAdapter(this@DaysWeightLossFragment)
    ...
    private fun fillDaysArray(): ArrayList<DayModel> {
        ...
        resources.getStringArray(R.array.day_exercises_weitng_lose).forEach {
            model.currentDay++
    ...
    private fun fillExerciseList(day: DayModel) {
        ...
        day.exercises.split(".").forEach {
            val exerciseList = resources.getStringArray(R.array.exercise_weiting_loss)
    ...
    companion object {
        @JvmStatic
        fun newInstance() = DaysWeightLossFragment()
    }
    ...
    override fun onClick(day: DayModel) {
        if(!day.isDone) {
            ...
            FragmentManager.setFragment(
                ExercisesListWeightLossFragment.newInstance(),
                activity as AppCompatActivity
            )
        }
        else{
