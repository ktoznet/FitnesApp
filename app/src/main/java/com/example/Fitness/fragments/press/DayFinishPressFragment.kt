...
class DayFinishPressFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.bDone.setOnClickListener {
            FragmentManager.setFragment(DaysPressFragment.newInstance(), activity as AppCompatActivity)
        }
    }

    companion object {
        @JvmStatic
        fun newInstance() = DayFinishPressFragment()
    }
}