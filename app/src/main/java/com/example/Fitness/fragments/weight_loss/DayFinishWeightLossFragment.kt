...
class DayFinishWeightLossFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.bDone.setOnClickListener {
            FragmentManager.setFragment(DaysWeightLossFragment.newInstance(), activity as AppCompatActivity)
        }
    }

    companion object {
        @JvmStatic
        fun newInstance() = DayFinishWeightLossFragment()
    }
}