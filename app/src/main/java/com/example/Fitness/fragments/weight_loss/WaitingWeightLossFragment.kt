...
import com.example.Fitness.fragments.strong.ExercisesFragment
...
class WaitingWeightLossFragment : Fragment() {
        ...
        timer = object : CountDownTimer(CONT_DOWN_TIME, 1){
            ...
            override fun onFinish() {
                FragmentManager.setFragment(
                    ExercisesWeightLossFragment.newInstance(),
    ...
    companion object {
        @JvmStatic
        fun newInstance() = WaitingWeightLossFragment()
    }
}