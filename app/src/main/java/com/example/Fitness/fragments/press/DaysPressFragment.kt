package com.example.Fitness.fragments.press
...
class DaysPressFragment : Fragment(), DaysAdapter.Listener {
    ...
    private fun initRcView() = with(binding) {
         adapter = DaysAdapter(this@DaysPressFragment)
    ...
    private fun fillDaysArray(): ArrayList<DayModel> {
        ...
        resources.getStringArray(R.array.day_exercises_press).forEach {
            model.currentDay++
    ...
    private fun fillExerciseList(day: DayModel) {
        ...
        day.exercises.split(".").forEach {
            val exerciseList = resources.getStringArray(R.array.exercise_press)
    ...
    companion object {
        @JvmStatic
        fun newInstance() = DaysPressFragment()
    }
    ...
    override fun onClick(day: DayModel) {
        if(!day.isDone) {
            ...
            FragmentManager.setFragment(
                ExercisesListPressFragment.newInstance(),
                activity as AppCompatActivity
            )
        }
        else{
